...
if (!function_exists('deductPoints')) {
...
if (!function_exists('getDocumentPoints')) {
...
if (!function_exists('setDocumentPoints')) {
...
if (!function_exists('getPendingDocuments')) {
...
if (!function_exists('getDocumentForApproval')) {
...
if (!function_exists('approveDocument')) {
...
if (!function_exists('rejectDocument')) {
...
if (!function_exists('canUserDownloadDocument')) {
...
if (!function_exists('purchaseDocument')) {
...
if (!function_exists('getTransactionHistoryCount')) {
