...
<div class="fixed bottom-0 left-0 right-0 z-[100] bg-base-100/60 backdrop-blur-2xl border-t border-base-content/5 shadow-[0_-10px_30px_-15px_rgba(0,0,0,0.1)] pb-[env(safe-area-inset-bottom)] lg:hidden transition-all duration-300">
    <div class="flex items-center justify-around p-2 h-[4.5rem]">
        ...
        <!-- More (Dropdown) -->
        <div class="dropdown dropdown-top w-[20%] flex justify-center">
            ...
            <!-- Dropdown Menu -->
            <ul tabindex="0" class="dropdown-content menu p-2 shadow-2xl bg-base-100/70 backdrop-blur-xl rounded-2xl w-56 mb-4 border border-base-content/10 text-base-content z-50 bottom-full left-0 animate-bounce-slow origin-bottom-left">
